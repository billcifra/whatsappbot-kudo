...
def webhook():
    ...
    try:
        ...
        if "messages" in value:
            ...
            prompt = ("Eres un asistente virtual del centro de artes marciales *KUDO Bolivia*, ubicado en la calle "
                      "Cañada Strongest N.º 1847 - a pasos de la plaza del estudiante, en la ciudad de La Paz, Bolivia."
                      ...
                      "(BJJ)*, *Kick Boxing* y *Defensa Personal*.\n"
                      "\n"
                      "🥋 *¿Qué es Kudo?*\n"
                      ...
                      "\n"
                      "📍 *Brazilian Jiu-Jitsu (todas las edades)*\n"
                      "— *Con Gi:*\n"
                      "   🕗 *Turno mañana:*\n"
